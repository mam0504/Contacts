...
namespace Contacts {
    ...
    public partial class PersonsDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonRow AddPersonRow(string FirstName, string LastName, string Phone, string Email, string Address, byte[] Picture) {
...
namespace Contacts.PersonsDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Person] ([FirstName], [LastName], [Phone], [Email], [Address], [Picture]) VALUES (@FirstName, @LastName, @Phone, @Email, @Address, @Picture);
SELECT Id, FirstName, LastName, Phone, Email, Address, Picture FROM Person WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [FirstName] = @FirstName, [LastName] = @LastName, [Phone] = @Phone, [Email] = @Email, [Address] = @Address, [Picture] = @Picture WHERE (([Id] = @Original_Id) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT Id, FirstName, LastName, Phone, Email, Address, Picture FROM Person WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\Persons.mdf;I" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Phone, Email, Address, Picture FROM dbo.Person";
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_Phone, string Original_Email, string Original_Address) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Phone, string Email, string Address, byte[] Picture) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Phone, string Email, string Address, byte[] Picture, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Phone, string Original_Email, string Original_Address, int Id) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Phone, string Email, string Address, byte[] Picture, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Phone, string Original_Email, string Original_Address) {
            return this.Update(FirstName, LastName, Phone, Email, Address, Picture, Original_Id, Original_FirstName, Original_LastName, Original_Phone, Original_Email, Original_Address, Original_Id);
        }
    }
